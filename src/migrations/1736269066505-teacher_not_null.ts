...
export class TeacherNotNull1736269066505 implements MigrationInterface {
    name = 'TeacherNotNull1736269066505'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "classroom" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "className" varchar NOT NULL, "teacherId" integer NOT NULL)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_classroom" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "className" varchar NOT NULL, "teacherId" integer NOT NULL, CONSTRAINT "FK_2b3c1fa62762d7d0e828c139130" FOREIGN KEY ("teacherId") REFERENCES "user" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
